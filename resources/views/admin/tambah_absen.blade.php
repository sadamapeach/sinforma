    ...
    <body>
        <div class="p-4 sm:ml-64">
            <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
                ...
                <form class="space-y-4 md:space-y-6" method="POST" autocomplete="on" action="{{ route('store_absen') }}" >
                    @csrf
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="mulai_absen" id="mulai_absen" value="{{ \Carbon\Carbon::now('Asia/Jakarta')->format('Y-m-d\TH:i') }}">
                        </div>
                        <div class="form-group">
                            <label for="selesai_absen" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Selesai Absen</label>
                            <input type="datetime-local" name="selesai_absen" id="selesai_absen" value="{{ \Carbon\Carbon::now('Asia/Jakarta')->format('Y-m-d\TH:i') }}">
                        </div>
                    </div>
