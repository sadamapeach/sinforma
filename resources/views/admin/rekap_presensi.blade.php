...
<body>
    <div class="p-4 sm:ml-64">
        ...
        @foreach ($generate_absen as $absen)
            ...
            <div class="p-5 mb-3 bg-white border border-gray-200 shadow rounded-lg dark:bg-gray-900 dark:border-gray-800 card">
