                                    ...
                                    @foreach ($mahasiswa as $index => $mhs)
                                        <tr class="text-xs bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-300 dark:border-black">
                                            ...
                                            <td class="px-4 py-3.5 w-32 text-center">
                                                @if ($mhs->status == 'Aktif')
                                                    <span type="botton" class="px-4 py-3.5 w-20 text-center" style="font-size: 12px">Aktif</span>
                                                @else
                                                    @if ($mhs->status == 'Tidak Aktif')
                                                        <span type="submit" class="px-4 py-3.5 w-20 text-center" style="font-size: 12px">Tidak Aktif</span>
                                                    @else
                                                        <span type="submit" class="px-4 py-3.5 w-20 text-center" style="font-size: 12px">Lulus</span>
                                                    @endif
                                                @endif
                                            </td>
                                            <td class="px-4 py-3.5 w-32 text-center">
