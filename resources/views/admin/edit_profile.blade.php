...
<body>
    <div class="p-4 sm:ml-64">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <div class="flex justify-center">
                                    <form method="POST" action="{{route('delete_profile_admin')}}">
                                        @csrf
        ...
        <form method="POST" autocomplete="on" action="{{ route('edit_profil') }}" enctype="multipart/form-data">
            @csrf
            {{-- Edit --}}     
            ...
            <div class="flex justify-end mb-2">
                {{-- Kembali --}}
                <a href="{{ route('view_profil') }}" class="text-white bg-red-700 hover:bg-red-800 focus:outline-none font-medium rounded-md text-xs w-20 h-8 text-center me-2 dark:bg-red-600 dark:hover:bg-red-700">
