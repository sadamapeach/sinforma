<aside id="logo-sidebar" class="fixed z-40 w-64 h-screen flex flex-col transition-transform -translate-x-full sm:translate-x-0 font-poppins overflow-hidden bg-zinc-100 dark:bg-gray-800 overflow-y-auto" aria-label="Sidebar">
   {{-- Logo dan Header --}}
