        ...
        <div class="p-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-800 rounded-lg shadow mt-3">
            ...
            <form action="{{ route('edit_nilai_mentor', ['id_mhs' => $mahasiswa->id_mhs]) }}" method="post">
                    ...
                    <tbody class="text-gray-800 dark:text-gray-200 border dark:border-black text-xs font-medium">
                        <tr class="bg-white dark:bg-gray-800 dark:border-black">
                            ...
                            <td class="py-3 px-4 border dark:border-black">
                                <input type="number" id="nilai1" name="nilai1" value="{{ $nilai->nilai1 }}" class="w-full border rounded py-1 px-2 dark:bg-gray-700 text-xs" min="0">
                                @error('nilai1')
                        ...
                        <tr class="bg-white dark:bg-gray-800 dark:border-black">
                            ...
                            <td class="py-3 px-4 border dark:border-black">
                                <input type="number" id="nilai2" name="nilai2" value="{{ $nilai->nilai2 }}" class="w-full border rounded py-1 px-2 dark:bg-gray-700 text-xs" min="0">
                                @error('nilai2')
                                    <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-100 dark:bg-gray-800 dark:text-red-400"
                                        role="alert">
                                        <div>
                        ...
                        <tr class="bg-white dark:bg-gray-800 dark:border-black">
                            ...
                            <td class="py-3 px-4 border dark:border-black">
                                <input type="number" id="nilai3" name="nilai3" value="{{ $nilai->nilai3 }}" class="w-full border rounded py-1 px-2 dark:bg-gray-700 text-xs" min="0">
                                @error('nilai3')
                                    <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-100 dark:bg-gray-800 dark:text-red-400"
                                        role="alert">
                                        <div>
                        ...
                        <tr class="bg-white dark:bg-gray-800 dark:border-black">
                            ...
                            <td class="py-3 px-4 border dark:border-black">
                                <input type="number" id="nilai4" name="nilai4" value="{{ $nilai->nilai4 }}" class="w-full border rounded py-1 px-2 dark:bg-gray-700 text-xs" min="0">
                                @error('nilai4')
                                    <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-100 dark:bg-gray-800 dark:text-red-400"
                                        role="alert">
                                        <div>
                ...
                <div class="flex mt-3">
                    ...
                    {{-- Simpan --}}
                    <button type="submit" name="submit" value="generate" class="ml-auto text-white bg-blue-700 hover:bg-blue-800 focus:outline-none font-medium rounded-md text-xs w-40 h-8 text-center dark:bg-blue-600 dark:hover:bg-blue-700 -mr-0.5">
                        Simpan Perubahan
                    </button>
                </div>
            </form>
