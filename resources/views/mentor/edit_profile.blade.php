    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="relative rounded-lg w-full bg-white dark:bg-gray-700 h-28">
            ...
            <div class="flex py-12 pl-6">
                <img class="w-32 h-32 p-1 rounded-full ring-4 ring-green-400 relative" src="{{ asset(Auth::user()->getImageURL()) }}" alt="Bordered avatar">
        ...
        <form method="POST" autocomplete="on" action="{{ route('edit_profil_mentor') }}" enctype="multipart/form-data">
            @csrf
            {{-- Edit --}}     
            ...
            <div class="flex justify-end mb-2">
                {{-- Kembali --}}
                <a href="{{ route('view_profil_mentor') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none font-medium rounded-full text-sm w-24 h-9 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700">
