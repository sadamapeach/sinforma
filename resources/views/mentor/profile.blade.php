...
<body>
    <div class="p-4 sm:ml-64">
            ...
            <div class="flex py-12 pl-6">
                ...
                <div class="z-10 ml-4 w-full" style="margin-top: 70px">
                    <div class="flex items-center justify-between">
                        {{-- Header --}}
                        <div class="font-bold text-lg text-black dark:text-white">{{ $mentor->nama }}</div>
                    ...
                    <div class="flex items-center text-xs mb-1">
                        <span class="text-gray-700 dark:text-gray-400">NIP. {{ $mentor->nip }}</span>
                    </div>
        ...
        <form action="{{ route('password_mentor') }}" method="POST">
            @csrf
