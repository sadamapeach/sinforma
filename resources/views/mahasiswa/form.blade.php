      ...
      <section class="form d-flex">
            ...
            <div class="col-lg-8">
              ...
              <div class="header" style="margin-top: 12%">
                <div  style="display: flex; align-items: center">
                  <div><img src="{{ asset('assets/logo.png') }}" alt="logo_diskominfo" class="mb-2" style="width: 25%"></div>
        ...
        <div class="login-right w-50 h-100" style="position:fixed; margin-left:50%">
          ...
          <div class="carousel-inner">
              ...
              <img src="{{ asset('assets/magang_1.png') }}" class="img-fluid" alt="">
              </div>
              {{-- Gambar 2 --}}
              <div class="carousel-item">
              <img src="{{ asset('assets/magang_3.png') }}" class="img-fluid" alt="">
              </div>
              {{-- Gambar 3 --}}
              <div class="carousel-item">
              <img src="{{ asset('assets/magang_2.png') }}" class="d-block w-100" alt="">
              </div>
          </div>
