...
<!DOCTYPE html>
    ...
    <body class="font-poppins"> 
        <div class="p-4 sm:ml-64">
            ...
            <div>
                <form method="POST" action="{{ route('update_presensi', ['id_absen' => $id_absen]) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-6">
                    ...
                    <div class="grid gap-5 mb-6 md:grid-cols-1">
                        ...
                        {{-- Foto --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-900 dark:text-white" for="foto">Upload Bukti Kehadiran</label>
                            <div class="flex mb-2">
                                <p class="text-gray-500" style="font-size: 11px">Tampilkan bukti kehadiran yang sudah diupload sebelumnya : </p>
                                <a href="{{ route('bukti_kehadiran', ['id_absen' => $absen->id_absen]) }}" class="py-0.5 bg-green-100 hover:bg-green-200 text-green-800 font-medium hover:font-semibold me-2 px-2.5 rounded-full dark:bg-green-900 hover:dark:bg-green-950 dark:text-green-300 ml-0.5" style="font-size: 9px">
                                    Show File
                                </a>
                            </div>
                    ...
                    <div class="flex justify-end mb-2">
                        ...
                        {{-- Submit --}}
                        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none font-medium rounded-md text-xs w-20 h-8 text-center dark:bg-blue-600 dark:hover:bg-blue-700">Submit</button>
                    </div>
